...
(() => {
  ...
  const DICT = {
    en: {
      ...
      'home.start.lede': 'Download the client, join your team in three steps, or read the guides first.',
      ...
      'home.start.q2.h3': 'Three steps, three minutes',
      'home.start.q2.p': 'Run the installer, paste the install code your PM sent, done — your AI usage joins the team board and idle compute joins the pool.',
      ...
      'dl.inst.lede': 'Run the installer, and your browser opens to sign in when it finishes. If your team lead already sent you an install code, see <a href="/join.html" style="color:var(--amber-hi)">the join page</a>.',
      ...
      'dl.inst.mac.alt': 'Already have an install code from your team? Append <span class="mono">-s -- --token &lt;code&gt;</span> and it onboards without any prompts.',
      'dl.inst.win.h3': 'Windows <span class="os">powershell</span>',
      'dl.inst.win.p': 'Paste into PowerShell with the install code from your team page. Installs per-user, no admin rights.',
      'dl.inst.win.alt': 'Replace <span class="mono">&lt;code&gt;</span> with your install code — sign in at the platform and copy it from your Me page.',
      ...
      'join.meta.desc': 'Join your team on Matrix in three steps: run the installer, paste your install code, done.',
      'join.kicker': 'Join your team · 加入团队',
      'join.h1': 'Three steps. About three minutes.',
      'join.lede': 'Your team runs on Matrix. Joining connects your AI work to the team board and lets your idle AI compute help the pool — credentials never leave your machine. <span class="zh" style="margin-top:8px">团队在用 Matrix。加入 = 你的 AI 使用情况接入团队看板 + 空闲 AI 算力可被团队调度。账号凭证只留在你自己的电脑上。</span>',
      'join.s1.h3': 'Run the installer',
      'join.s1.p': 'Paste one line into your terminal. No admin rights. When it finishes, your browser opens by itself. <span class="zh">终端粘贴一行命令，不需要管理员权限；装完浏览器会自动打开。</span>',
      'join.s1.alt': 'Prefer clicking to typing? <a href="/downloads.html" style="color:var(--amber-hi)">Download the standalone zip</a> and double-click <span class="mono">安装Matrix.command</span> instead.',
      'join.s2.h3': 'Paste your install code',
      'join.s2.p': "In the browser page that just opened: sign in (or register — work email + password, ten seconds). If your PM sent you an invite link, open it to land in the team. Then copy the install code the page shows you — or use the one your PM sent, if it's fresh — and paste it back into the install window. <span class=\"zh\">在打开的网页里注册/登录（PM 发了邀请链接就先点它进团队），把页面显示的安装码粘贴回安装窗口。PM 直接发给你的安装码也行——码有时效，过期就在网页上重新复制一个。</span>",
      'join.s3.h3': 'Done',
      'join.s3.p': "You're on the team. Your AI usage shows up on the team board, and your idle AI compute can be scheduled into the team pool — nothing else to configure. <span class=\"zh\">完成。你的 AI 使用情况已接入团队，空闲算力可被调度，无需再配置任何东西。</span>",
      'join.invite.h2': 'For team leads: the invite message.',
      'join.invite.p': 'Copy, paste into your team chat, attach your invite link and you\'re done. <span class="zh">给 PM / 负责人：复制下面这段发到团队群，补上你的邀请链接即可。</span>',
      ...
      'guides.g2.li2': 'Your browser opens to the platform. Sign in (or register — see guide 01), then copy the <strong>install code</strong> the page shows you and paste it back into the install window.',
      ...
      'guides.g3.li2': "Install the client (guide 02) if you haven't. When the browser opens, the install code you paste ties the machine to you <em>inside the team</em>.",
      'guides.g3.li3': "That's all. Your AI usage appears on the team board, and idle capacity becomes schedulable. The full three-step walkthrough lives at <a href=\"/join.html\">aiwall.com/join</a>.",
      ...
      'guides.g4.li1': '<strong>Invite.</strong> Create your team on the platform, copy your invite link, and send the ready-made message from <a href="/join.html">the join page</a> to your team chat. Each person is three steps from joined.',
      ...
      'guides.g5.li4': "Something off? Re-run the installer from <a href=\"/downloads.html\">downloads</a> — it's idempotent — or ask your PM to re-send a fresh install code.",
    ...
    zh: {
      ...
      'home.start.lede': '下载客户端、三步加入团队，或先读读使用指导。',
      ...
      'home.start.q2.h3': '三步，三分钟',
      'home.start.q2.p': '运行安装命令，粘贴 PM 发来的安装码，完成——你的 AI 使用情况接入团队看板，空闲算力进入团队池。',
      ...
      'dl.inst.lede': '运行安装命令，装完浏览器会自动打开登录页。团队负责人已经发过安装码？看<a href="/join.html" style="color:var(--amber-hi)">加入团队页</a>。',
      ...
      'dl.inst.mac.alt': '已经拿到团队的安装码？在命令后追加 <span class="mono">-s -- --token &lt;安装码&gt;</span>，全程免交互直接入职。',
      'dl.inst.win.h3': 'Windows <span class="os">powershell</span>',
      'dl.inst.win.p': '连同团队页面上的安装码一起粘贴到 PowerShell。按用户安装，无需管理员权限。',
      'dl.inst.win.alt': '把 <span class="mono">&lt;code&gt;</span> 换成你的安装码——登录平台后在「我的」页面复制。',
      ...
      'join.meta.desc': '三步加入团队：运行安装命令、粘贴安装码、完成。',
      'join.kicker': '加入团队',
      'join.h1': '三步，大约三分钟。',
      'join.lede': '你的团队在用 Matrix。加入后，你的 AI 使用情况接入团队看板，空闲 AI 算力可以支援团队池——账号凭证永远只留在你自己的电脑上。',
      'join.s1.h3': '运行安装命令',
      'join.s1.p': '往终端里粘贴一行命令。不需要管理员权限。装完后浏览器会自动打开。',
      'join.s1.alt': '不想敲命令？<a href="/downloads.html" style="color:var(--amber-hi)">下载独立压缩包</a>，双击 <span class="mono">安装Matrix.command</span> 即可。',
      'join.s2.h3': '粘贴你的安装码',
      'join.s2.p': '在刚打开的网页里登录（或注册——工作邮箱 + 密码，十秒钟）。PM 发了邀请链接就先点它进团队。然后把页面显示的安装码——或 PM 直接发给你的、还没过期的那个——粘贴回安装窗口。',
      'join.s3.h3': '完成',
      'join.s3.p': '你已经在团队里了。你的 AI 使用情况出现在团队看板上，空闲 AI 算力可以被调度进团队池——不需要再配置任何东西。',
      'join.invite.h2': '给团队负责人：现成的邀请文案。',
      'join.invite.p': '复制、粘贴到团队群，补上你的邀请链接，就完成了。',
      ...
      'guides.g2.li2': '浏览器打开平台页面。登录（或注册，见指导 01），复制页面显示的<strong>安装码</strong>，粘贴回安装窗口。',
      ...
      'guides.g3.li2': '还没装客户端就按指导 02 装。浏览器打开后，你粘贴的安装码会把这台机器<em>在团队内</em>关联到你。',
      ...
      'guides.g4.li1': '<strong>邀请。</strong>在平台上建团队，复制邀请链接，把 <a href="/join.html">join 页</a>的现成文案发到团队群。每个人离加入只有三步。',
      ...
      'guides.g5.li4': '感觉不对劲？从<a href="/downloads.html">下载页</a>重跑一遍安装命令（可重复执行），或让 PM 重新发一个安装码。',
